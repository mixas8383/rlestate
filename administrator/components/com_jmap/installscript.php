	...
	*/
	...
	function install($parent) {
		...
		if($targetRobot !== false) {
			...
			// Repair the standard Joomla 3- robots.txt for nowadays Google indexing
			...
			if(!preg_match('#Allow: \/\*\.js\*#', $managedRobotContents)) {
				$managedRobotContents = preg_replace('#User-agent: \*#i', 'User-Agent: Googlebot' .
																PHP_EOL . 'Allow: /*.js*' .
																PHP_EOL . 'Allow: /*.css*' .
																PHP_EOL . 'Allow: /*.png*' .
																PHP_EOL . 'Allow: /*.jpg*' .
																PHP_EOL . 'Allow: /*.gif*' .
																PHP_EOL .
																PHP_EOL . 'User-Agent: *', $managedRobotContents);
			}
