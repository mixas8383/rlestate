/*1435063570,,JIT Construction: v1799518,en_US*/
...
try {
    window.FB || (function (window) {
        ...
        (function () {
            var a = {}, b = function (i, j) {
                ...
                return b(i && /^[A-Z]/.test(i) ? i : (void 0), j && ((j.params && j.params.length) || j.returns) ? 'function(' + (j.params ? j.params.map(function (k) {
                    return (/\?/).test(k) ? '?' + k.replace('?', '') : k;
                }).join(',') : '') + ')' + (j.returns ? ':' + j.returns : '') : (void 0));
            }, d = function (i, j, k) {
                return i;
            }, e = function (i, j, k) {
                ...
                if (m) {
                    if (!m.callId)
                        m.callId = m.module + ':' + m.line + ':' + m.column;
                    var n = m.callId;
                    a[n] = (a[n] || 0) + 1;
                }
                return k.apply(i, j);
        ...
        var ES = require('ES');
        __d("JSSDKRuntimeConfig", [], {"locale": "en_US", "rtl": false, "revision": "1799518"});
        ...
        __d("sdk.createIframe", ["DOMEventListener", "getBlankIframeSrc", "guid", "hasNamePropertyBug"], function (a, b, c, d, e, f, g, h, i, j) {
            ...
            function k(l) {
                ...
                delete l.onload;
                delete l.onerror;
                var t = ES('Object', 'assign', false, {frameBorder: 0, allowTransparency: true, allowFullscreen: true, scrolling: 'no'}, l);
                if (t.width)
                    m.width = t.width + 'px';
                if (t.height)
        ...
        __d("sdk.Impressions", ["sdk.Content", "Miny", "QueryString", "sdk.Runtime", "UrlMap", "getBlankIframeSrc", "guid", "insertIframe"], function (a, b, c, d, e, f, g, h, i, j, k, l, m, n) {
            ...
            function o(q) {
                ...
                if (t.length <= 2000) {
                    ...
                    n({url: l(), root: x, name: w, className: 'fb_hidden fb_invisible', onload: function () {
                            x.parentNode.removeChild(x);
                        }});
                    g.submitToTarget({url: s, target: w, params: q});
                }
            }
            var p = {log: function (q, r) {
                    if (!r.source)
                        r.source = 'jssdk';
        ...
        __d("URISchemes", ["createObjectFrom"], function (a, b, c, d, e, f, g) {
            b.__markCompiled && b.__markCompiled();
            var h = g(['fb', 'fb-ama', 'fb-messenger', 'fbcf', 'fbconnect', 'fbmobilehome', 'fbrpc', 'file', 'ftp', 'http', 'https', 'mailto', 'ms-app', 'itms', 'itms-apps', 'itms-services', 'market', 'svn+ssh', 'fbstaging', 'tel', 'sms', 'pebblejs', 'sftp']), i = {isAllowed: function (j) {
                    if (!j)
                        return true;
        ...
        __d("URIBase", ["URIRFC3986", "URISchemes", "ex", "invariant"], function (a, b, c, d, e, f, g, h, i, j) {
            b.__markCompiled && b.__markCompiled();
            var k = new RegExp('[\\x00-\\x2c\\x2f\\x3b-\\x40\\x5c\\x5e\\x60\\x7b-\\x7f' + '\\uFDD0-\\uFDEF\\uFFF0-\\uFFFF' + '\\u2047\\u2048\\uFE56\\uFE5F\\uFF03\\uFF0F\\uFF1F]'), l = new RegExp('^(?:[^/]*:|' + '[\\x00-\\x1f]*/[\\x00-\\x1f]*/)');
            function m(p, q, r, s) {
                if (!q)
                    return true;
                if (q instanceof o) {
                ...
                if (t.userinfo !== null)
                    if (r) {
                        throw new Error(i('URI.parse: invalid URI (userinfo is not allowed in a URI): %s', p.toString()));
                    } else
                        return false;
                if (!p.getDomain() && ES(p.getPath(), 'indexOf', true, '\\') !== -1)
                    if (r) {
                        throw new Error(i('URI.parse: invalid URI (no domain but multiple back-slashes): %s', p.toString()));
                    } else
                        return false;
                if (!p.getProtocol() && l.test(q))
                    if (r) {
                        throw new Error(i('URI.parse: invalid URI (unsafe protocol-relative URLs): %s', p.toString()));
                    } else
                        return false;
                return true;
            }
            ...
            o.prototype.setDomain = function (p) {
                "use strict";
                if (k.test(p))
                    throw new Error(i('URI.setDomain: unsafe domain specified: %s for url %s', p, this.toString()));
                this.$URIBase2 = p;
                return this;
            };
            ...
            o.prototype.addQueryData = function (p, q) {
                ...
                if (Object.prototype.toString.call(p) === '[object Object]') {
                    ES('Object', 'assign', false, this.$URIBase6, p);
                } else
                    this.$URIBase6[p] = q;
                return this;
            };
            ...
            o.isValidURI = function (p, q) {
                return m(new o(null, q), p, false, q);
            };
            e.exports = o;
        }, null);
        ...
        __d("Flash", ["DOMEventListener", "DOMWrapper", "FlashVersionFix", "QueryString", "UserAgent_DEPRECATED", "copyProperties", "guid", "htmlSpecialChars"], function (a, b, c, d, e, f, g, h, i, j, k, l, m, n) {
            b.__markCompiled && b.__markCompiled();
            var o = {}, p, q = h.getWindow().document;
            function r(w) {
                var x = q.getElementById(w);
                if (x)
                    x.parentNode.removeChild(x);
                delete o[w];
            }
            ...
            function t(w) {
                return w.replace(/\d+/g, function (x) {
                    return '000'.substring(x.length) + x;
                });
            }
            function u(w) {
                if (!p) {
                    if (k.ie() >= 9)
                        g.add(window, 'unload', s);
                    p = true;
                }
                o[w] = w;
            }
            var v = {embed: function (w, x, y, z) {
                    var aa = m();
                    w = n(w).replace(/&amp;/g, '&');
                    y = l({allowscriptaccess: 'always', flashvars: z, movie: w}, y || {});
                    if (typeof y.flashvars == 'object')
                        y.flashvars = j.encode(y.flashvars);
                    var ba = [];
                    for (var ca in y)
                        if (y.hasOwnProperty(ca) && y[ca])
                            ba.push('<param name="' + n(ca) + '" value="' + n(y[ca]) + '">');
                    var da = x.appendChild(q.createElement('span')), ea = '<object ' + (k.ie() ? 'classid="clsid:d27cdb6e-ae6d-11cf-96b8-444553540000" ' : 'type="application/x-shockwave-flash"') + 'data="' + w + '" ' + (y.height ? 'height="' + y.height + '" ' : '') + (y.width ? 'width="' + y.width + '" ' : '') + 'id="' + aa + '">' + ba.join('') + '</object>';
                    da.innerHTML = ea;
                    var fa = da.firstChild;
                    u(aa);
                    return fa;
                }, remove: r, getVersion: function () {
        ...
        __d("sdk.Auth", ["sdk.Cookie", "sdk.createIframe", "DOMWrapper", "sdk.feature", "sdk.getContextType", "guid", "sdk.Impressions", "Log", "ObservableMixin", "sdk.Runtime", "sdk.SignedRequest", "UrlMap", "sdk.URI", "sdk.XD"], function (a, b, c, d, e, f, g, h, i, j, k, l, m, n, o, p, q, r, s, t) {
            ...
            function aa(da) {
                ...
                var ga = z(da, u, 'login_status'), ha = new s(r.resolve('www', true) + '/connect/ping').setQueryData({client_id: p.getClientID(), response_type: 'token,signed_request,code', domain: location.hostname, origin: k(), redirect_uri: t.handler(function (ia) {
                ...
                switch (ga) {
                    ...
                    default:
                        return l.guard(function () {
                            ...
                            function ha(oa) {
                                if (ES('Array', 'isArray', false, oa))
                                    return ES(oa, 'map', true, ha);
                                if (oa && typeof oa === 'object' && oa.__wrapped)
                                    return oa.__wrapped;
                            ...
                            if (ja && typeof ja === 'object') {
                                ...
                                for (var ma in ja) {
                                    var na = ja[ma];
                                    if (typeof na !== 'function' || ma === 'constructor')
                                        continue;
                                    la = false;
        ...
        __d("JSONPRequest", ["DOMWrapper", "GlobalCallback", "QueryString"], function (a, b, c, d, e, f, g, h, i) {
            ...
            var j = 2000;
            function k(m, n, o, p) {
                var q = document.createElement('script'), r = function (t) {
                    r = function () {};
                    h.remove(o.callback);
                    p(t);
                ...
                q.onerror = function () {
                    r({error: {type: 'http', message: 'unknown error'}});
                };
                var s = function () {
                    setTimeout(function () {
                        r({error: {type: 'http', message: 'unknown error'}});
                ...
                q.src = m;
                g.getRoot().appendChild(q);
                return true;
            }
            var l = {execute: k, MAX_QUERYSTRING_LENGTH: j};
            e.exports = l;
        }, null);
        __d("ApiClient", ["ArgumentError", "Assert", "CORSRequest", "FlashRequest", "flattenObject", "JSONPRequest", "Log", "ObservableMixin", "QueryString", "sprintf", "sdk.URI", "UrlMap", "ApiClientConfig", "invariant"], function (a, b, c, d, e, f, g, h, i, j, k, l, m, n, o, p, q, r, s, t) {
            b.__markCompiled && b.__markCompiled();
            var u, v, w, x = l.MAX_QUERYSTRING_LENGTH, y = {get: true, post: true, 'delete': true, put: true}, z = {fql_query: true, fql_multiquery: true, friends_get: true, notifications_get: true, stream_get: true, users_getinfo: true}, aa = [], ba = [], ca = null, da = 0, ea = [], fa = 0, ga = 50, ha = 105440539523;
            function ia(ra, sa, ta, ua) {
                var va = fa !== 0 && da >= fa;
                if (va) {
                    ea.push(function () {
                        return ia(ra, sa, ta, ua);
                    });
                    pa.inform('request.queued', ra, sa, ta);
                    return;
                }
                da++;
                if (w)
                    ta = ES('Object', 'assign', false, {}, w, ta);
                ta.access_token = ta.access_token || u;
                ta.pretty = ta.pretty || 0;
                ta = k(ta);
                var wa = {jsonp: l, cors: i, flash: j}, xa;
                if (ta.transport) {
                    xa = [ta.transport];
                    delete ta.transport;
                } else
                ...
                for (var ya = 0; ya < xa.length; ya++) {
                    var za = wa[xa[ya]], ab = ES('Object', 'assign', false, {}, ta);
                    if (za.execute(ra, sa, ab, ua))
                        return;
                }
                ua({error: {type: 'no-transport', message: 'Could not find a usable transport for request'}});
            }
            function ja(ra, sa, ta, ua, va, wa) {
                if (wa && wa.error)
                    pa.inform('request.error', sa, ta, ua, wa, ES('Date', 'now', false) - va);
                pa.inform('request.complete', sa, ta, ua, wa, ES('Date', 'now', false) - va);
                da--;
                if (ra)
                    ra(wa);
                var xa = ea.length > 0 && da < fa;
                if (xa) {
                    var ya = ea.shift();
                    ya();
                }
            ...
            function ka(ra) {
                var sa = ra.shift();
                h.isString(sa, 'Invalid path');
                if (!/^https?/.test(sa) && sa.charAt(0) !== '/')
                    sa = '/' + sa;
                var ta, ua = {};
                try {
                    ta = new q(sa);
                } catch (va) {
                    throw new g(va.message, va);
                }
                ES(ra, 'forEach', true, function (za) {
                    return ua[typeof za] = za;
                });
                var wa = (ua.string || 'get').toLowerCase();
                h.isTrue(y.hasOwnProperty(wa), p('Invalid method passed to ApiClient: %s', wa));
                var xa = ua['function'];
                if (!xa)
                    m.warn('No callback passed to the ApiClient');
                if (ua.object)
                    ta.addQueryData(k(ua.object));
                var ya = ta.getQueryData();
                ya.method = wa;
                return {uri: ta, callback: xa, params: ya};
            }
            function la() {
                for (var ra = [], sa = 0, ta = arguments.length; sa < ta; sa++)
                    ra.push(arguments[sa]);
                var ua = ka(ra), va = ua.uri, wa = ua.callback, xa = ua.params, ya = xa.method;
                if (qa(va, ya))
                    ya = 'post';
                var za = va.getProtocol() && va.getDomain() ? va.setQueryData({}).toString() : r.resolve('graph') + va.getPath();
                pa.inform('request.prepare', za, xa);
                ia(za, ya == 'get' ? 'get' : 'post', xa, ES(ja, 'bind', true, null, wa, va.getPath(), ya, xa, ES('Date', 'now', false)));
            }
            function ma() {
                for (var ra = [], sa = 0, ta = arguments.length; sa < ta; sa++)
                    ra.push(arguments[sa]);
                var ua = ka(ra), va = ua.uri, wa = ua.callback, xa = ua.params, ya = xa.method, za = {method: ya, relative_url: va.removeQueryData('method').toString()};
                if (ya.toLowerCase() == 'post') {
                    za.body = o.encode(va.getQueryData());
                    za.relative_url = va.setQueryData({}).toString();
                }
                aa.push(za);
                ba.push(wa);
                if (aa.length == ga) {
            ...
            function na() {
                ...
                ca = null;
                if (ra.length === 1) {
                    var ta = ra[0], ua = sa[0], va = ta.body ? o.decode(ta.body) : null;
                    la(ta.relative_url, ta.method, va, ua);
                    return;
                }
                la('/', 'POST', {batch: ra, include_headers: false, batch_app_id: v || ha}, function (wa) {
                    if (ES('Array', 'isArray', false, wa)) {
                        ES(wa, 'forEach', true, function (xa, ya) {
                            sa[ya](ES('JSON', 'parse', false, xa.body));
                        });
                    } else
                        ES(sa, 'forEach', true, function (xa) {
                            return xa({error: {message: 'Fatal: batch call failed.'}});
                        });
                });
            }
            function oa(ra, sa) {
                h.isObject(ra);
                h.isString(ra.method, 'method missing');
                if (!sa)
                    m.warn('No callback passed to the ApiClient');
                var ta = ra.method.toLowerCase().replace('.', '_');
                ra.format = 'json-strings';
                ra.api_key = v;
                var ua = ta in z ? 'api_read' : 'api', va = r.resolve(ua) + '/restserver.php', wa = ES(ja, 'bind', true, null, sa, '/restserver.php', 'get', ra, ES('Date', 'now', false));
                ia(va, 'get', ra, wa);
            }
            var pa = ES('Object', 'assign', false, new n(), {setAccessToken: function (ra) {
                    u = ra;
                }, getAccessToken: function () {
                    return u;
                }, setClientID: function (ra) {
                    v = ra;
                }, setDefaultParams: function (ra) {
                    w = ra;
                }, setMaxConcurrentRequests: function (ra) {
                    fa = ra;
                }, getCurrentlyExecutingRequestCount: function () {
                    return da;
                }, getQueuedRequestCount: function () {
                    return ea.length;
                }, rest: oa, graph: la, scheduleBatchCall: ma});
            function qa(ra, sa) {
                return (ra.toString().length > x && sa === 'get');
            }
        ...
        __d("sdk.api", ["ApiClient", "sdk.PlatformVersioning", "sdk.Runtime", "sdk.Scribe", "sdk.URI", "sdk.feature"], function (a, b, c, d, e, f, g, h, i, j, k, l) {
            ...
            g.subscribe('request.complete', function (p, q, r, s) {
                ...
                if (s && typeof s == 'object')
                    if (s.error) {
                        if (s.error == 'invalid_token' || (s.error.type == 'OAuthException' && s.error.code == 190))
                            t = true;
                    } else if (s.error_code)
                        if (s.error_code == '190')
                            t = true;
                if (t && n === i.getAccessToken())
                    i.setAccessToken(null);
            });
            g.subscribe('request.complete', function (p, q, r, s) {
                if (((p == '/me/permissions' && q === 'delete') || (p == '/restserver.php' && r.method == 'Auth.revokeAuthorization')) && s === true)
                    i.setAccessToken(null);
            });
            g.subscribe('request.error', function (p, q, r, s) {
                if (m && s.error.type === 'http')
                    j.log('jssdk_error', {appId: i.getClientID(), error: 'transport', extra: {name: 'transport', message: ES('JSON', 'stringify', false, s.error)}});
            });
            function o(p) {
                if (typeof p === 'string') {
                    if (i.getIsVersioned()) {
                        h.assertVersionIsSet();
                        if (!/https?/.test(p) && p.charAt(0) !== '/')
                            p = '/' + p;
                        p = new k(p).setDomain(null).setProtocol(null).toString();
                        if (!h.REGEX.test(p.substring(1, ES(p, 'indexOf', true, '/', 1))))
                            p = '/' + i.getVersion() + p;
        ...
        __d("sdk.Dialog", ["sdk.Canvas.Environment", "sdk.Content", "sdk.DOM", "DOMEventListener", "ObservableMixin", "sdk.Runtime", "Type", "sdk.UA", "sdk.fbt", "sdk.feature"], function (a, b, c, d, e, f, g, h, i, j, k, l, m, n, o, p) {
            ...
            var w = m.extend({constructor: function y(z, aa) {
                    this.parent();
                    this.id = z;
                    this.display = aa;
                    this._e2e = {};
        ...
        __d("sdk.UIServer", ["sdk.Auth", "sdk.Content", "sdk.DOM", "sdk.Dialog", "sdk.Event", "sdk.Frictionless", "Log", "sdk.Native", "QueryString", "sdk.RPC", "sdk.Runtime", "JSSDKConfig", "sdk.UA", "UrlMap", "sdk.XD", "createObjectFrom", "sdk.feature", "flattenObject", "sdk.getContextType", "guid", "insertIframe", "resolveURI"], function (a, b, c, d, e, f, g, h, i, j, k, l, m, n, o, p, q, r, s, t, u, v, w, x, y, z, aa, ba) {
            b.__markCompiled && b.__markCompiled();
            var ca = {transform: function (ia) {
                    if (ia.params.display === 'touch' && ia.params.access_token && window.postMessage) {
                        ia.params.channel = ha._xdChannelHandler(ia.id, 'parent');
                        if (!s.nativeApp())
                            ia.params.in_iframe = 1;
                        return ia;
                    } else
                        return ha.genericTransform(ia);
                }, getXdRelation: function (ia) {
                    var ja = ia.display;
                    if (ja === 'touch' && window.postMessage && ia.in_iframe)
                        return 'parent';
                    return ha.getXdRelation(ia);
                }}, da = {'stream.share': {size: {width: 670, height: 340}, url: 'sharer.php', transform: function (ia) {
                        if (!ia.params.u)
                            ia.params.u = window.location.toString();
                        ia.params.display = 'popup';
                        return ia;
                    }}, apprequests: {transform: function (ia) {
                        ia = ca.transform(ia);
                        ...
                        ia.closeIcon = false;
                        return ia;
                    }, getXdRelation: ca.getXdRelation}, feed: ca, 'permissions.oauth': {url: 'dialog/oauth', size: {width: (s.mobile() ? null : 475), height: (s.mobile() ? null : 183)}, transform: function (ia) {
                        if (!q.getClientID()) {
                        ...
                        delete ia.cb;
                        var la = ES('Object', 'keys', false, ES('Object', 'assign', false, ia.params.response_type ? v(ia.params.response_type.split(',')) : {}, {token: true, signed_request: true})).join(',');
                        if (ia.params.display === 'async') {
                            ES('Object', 'assign', false, ia.params, {client_id: q.getClientID(), origin: y(), response_type: la, domain: location.hostname});
                            ia.cb = g.xdResponseWrapper(ja, g.getAuthResponse(), 'permissions.oauth');
                        } else
                            ES('Object', 'assign', false, ia.params, {client_id: q.getClientID(), redirect_uri: ba(ha.xdHandler(ja, ka, 'opener', g.getAuthResponse(), 'permissions.oauth')), origin: y(), response_type: la, domain: location.hostname});
                        return ia;
                    }}, 'auth.logout': {url: 'logout.php', transform: function (ia) {
                        if (!q.getClientID()) {
                    ...
                    }}, 'login.status': {url: 'dialog/oauth', transform: function (ia) {
                        var ja = ia.cb, ka = ia.id;
                        delete ia.cb;
                        ES('Object', 'assign', false, ia.params, {client_id: q.getClientID(), redirect_uri: ha.xdHandler(ja, ka, 'parent', g.getAuthResponse(), 'login_status'), origin: y(), response_type: 'token,signed_request,code', domain: location.hostname});
                        return ia;
                    }}, pay: {size: {width: 555, height: 120}, connectDisplay: 'popup'}}, ea = {};
            function fa(ia, ja) {
                ea[ja] = true;
                return function (ka) {
                    delete ea[ja];
            ...
            function ga(ia) {
                if (!w('should_force_single_dialog_instance', true))
                    return false;
                var ja = ia.method.toLowerCase();
                if (ja === 'pay' && ia.display === 'async')
                    return true;
                return false;
            }
            var ha = {Methods: da, _loadedNodes: {}, _defaultCb: {}, _resultToken: '"xxRESULTTOKENxx"', genericTransform: function (ia) {
                    if (ia.params.display == 'dialog' || ia.params.display == 'iframe')
                        ES('Object', 'assign', false, ia.params, {display: 'iframe', channel: ha._xdChannelHandler(ia.id, 'parent.parent')}, true);
                    return ia;
                    ...
                    for (var la = 0; la < ka.length; la++)
                        if (!r.initSitevars.iframePermissions[ES(ka[la], 'trim', true)])
                            return 'popup';
                    return ia.display;
                    ...
                    ES('Object', 'assign', false, ia, {app_id: q.getClientID(), locale: q.getLocale(), sdk: 'joey', access_token: na && q.getAccessToken() || (void 0)});
                    ia.display = ha.getDisplayMode(la, ia);
                    if (!la.url)
                        la.url = 'dialog/' + ka;
                    if ((la.url == 'dialog/oauth' || la.url == 'dialog/permissions.request') && (ia.display == 'iframe' || (ia.display == 'touch' && ia.in_iframe)))
                        ia.display = ha.checkOauthDisplay(ia);
                    if (ia.display == 'popup')
                        delete ia.access_token;
                    if (q.getIsVersioned() && la.url.substring(0, 7) === 'dialog/')
                        la.url = ia.version + '/' + la.url;
                    if (ga(ia)) {
                        if (ea[ka]) {
                    ...
                    var pa = {cb: ja, id: ma, size: la.size || ha.getDefaultSize(), url: t.resolve(ia.display == 'touch' ? 'm' : 'www', na) + '/' + la.url, params: ia, name: ka, dialog: j.newInstance(ma, ia.display)}, qa = la.transform ? la.transform : ha.genericTransform;
                    if (qa) {
                        pa = qa(pa);
                        if (!pa)
                            return;
                    }
                    if (ia.display === 'touch' && ia.in_iframe)
                        pa.params.parent_height = window.innerHeight;
                    var ra = la.getXdRelation || ha.getXdRelation, sa = ra(pa.params);
                    if (!(pa.id in ha._defaultCb) && !('next' in pa.params) && !('redirect_uri' in pa.params))
                        pa.params.next = ha._xdResult(pa.cb, pa.id, sa, true);
                    if (sa === 'parent')
                        ES('Object', 'assign', false, pa.params, {channel_url: ha._xdChannelHandler(ma, 'parent.parent')}, true);
                    pa = ha.prepareParams(pa);
                    return pa;
                }, prepareParams: function (ia) {
                    if (ia.params.display !== 'async')
                        delete ia.params.method;
                    ...
                    if (ia.connectDisplay && !ka)
                        return ia.connectDisplay;
                    return ja.display || (q.getAccessToken() ? 'dialog' : 'popup');
                }, getXdRelation: function (ia) {
                    var ja = ia.display;
                    if (ja === 'popup' || ja === 'touch')
                        return 'opener';
                    if (ja === 'dialog' || ja === 'iframe' || ja === 'hidden' || ja === 'none')
                        return 'parent';
                    if (ja === 'async')
                    ...
                    if (ia.name == 'permissions.request' || ia.name == 'permissions.oauth')
                        sa.push('location=1,toolbar=0');
                    sa = sa.join(',');
                    var ta;
                    if (ia.post) {
                    ...
                    if (!ta)
                        return;
                    if (ia.id in ha._defaultCb)
                        ha._popupMonitor();
                }, setLoadedNode: function (ia, ja, ka) {
                    if (ia.params && ia.params.display != 'popup')
                        ja.fbCallID = ia.id;
                    ...
                    ia.root = j.create({onClose: ja, closeIcon: ia.closeIcon === (void 0) ? true : ia.closeIcon, classes: (s.ipad() ? 'centered' : '')});
                    if (!ia.hideLoader)
                        j.showLoader(ja, ia.size.width);
                    ...
                    var ja = function (ka) {
                        if (ia.id in ha._loadedNodes)
                            ha.setLoadedNode(ia, ka, 'iframe');
                    };
                    if (ia.post) {
                        aa({url: 'about:blank', root: ia.root, className: ia.className, width: ia.size.width, height: ia.size.height, id: ia.id, onInsert: ja, onload: function (ka) {
                                h.submitToTarget({url: ia.url, target: ka.name, params: ia.params});
                            }});
                    } else
                        aa({url: ia.url, root: ia.root, className: ia.className, width: ia.size.width, height: ia.size.height, id: ia.id, name: ia.frameName, onInsert: ja});
                }, _handleResizeMessage: function (ia, ja) {
                    var ka = ha.getLoadedNode(ia);
                    if (!ka)
                        return;
                    if (ja.height)
                        ka.style.height = ja.height + 'px';
                    if (ja.width)
                        ka.style.width = ja.width + 'px';
                    ...
                    for (var ja in ha._loadedNodes)
                        if (ha._loadedNodes.hasOwnProperty(ja) && ja in ha._defaultCb) {
                            ...
                            if (ka.type != 'popup' && ka.type != 'native')
                                continue;
                            var la = ka.node;
                            try {
                                if (la.closed) {
                    ...
                    if (ka)
                        ...
                        } else if (i.containsCss(ka, 'FB_UI_Dialog'))
                            j.remove(ka);
        ...
        __d("legacy:fb.canvas-legacy", ["Assert", "FB", "Log", "sdk.Canvas.Tti"], function (a, b, c, d, e, f, g, h, i, j) {
            b.__markCompiled && b.__markCompiled();
            h.provide('CanvasInsights', {setDoneLoading: function (k) {
        ...
        __d("sdk.init", ["sdk.Cookie", "sdk.ErrorHandling", "sdk.Event", "Log", "ManagedError", "sdk.PlatformVersioning", "QueryString", "sdk.Runtime", "sdk.URI", "createArrayFromMixed"], function (a, b, c, d, e, f, g, h, i, j, k, l, m, n, o, p) {
            ...
            function r(s) {
                ...
                if (n.getIsVersioned()) {
                    ...
                    if (!s.version)
                        s.version = new o(location.href).getQueryData().sdk_version;
        ...
        __d("legacy:fb.json", ["FB", "ManagedError"], function (a, b, c, d, e, f, g, h) {
            b.__markCompiled && b.__markCompiled();
            g.provide('JSON', {stringify: function (i) {
                    try {
        ...
        __d("IframePlugin", ["sdk.Auth", "sdk.DOM", "sdk.Event", "Log", "ObservableMixin", "sdk.PlatformVersioning", "PluginPipe", "QueryString", "sdk.Runtime", "Type", "sdk.UA", "sdk.URI", "UrlMap", "sdk.XD", "sdk.createIframe", "sdk.feature", "guid", "resolveURI"], function (a, b, c, d, e, f, g, h, i, j, k, l, m, n, o, p, q, r, s, t, u, v, w, x) {
            ...
            var ga = p.extend({constructor: function (ha, ia, ja, ka) {
                    this.parent();
                    ja = ja.replace(/-/g, '_');
                    ...
                    if (q.mobile()) {
                        ...
                        if (!this._iframeOptions.width) {
                            ...
                            if (q.iphone() || q.ipad())
                                ES('Object', 'assign', false, la, {width: '220px', 'min-width': '100%'});
                    ...
                    if ((ia + ha) > ja && ia > ha) {
                        ...
                        return;
                    t.sendToFacebook(this._iframe.name, {method: 'xd/reposition', params: ES('JSON', 'stringify', false, la)});
                }, updateLift: function () {
            ...
            ga.withParams = function (ha, ia) {
                return ga.extend({getParams: function () {
                        return ha;
                    }, getConfig: function () {
                        return ia ? ia : {};
                    }});
        ...
        __d("PluginConfig", ["sdk.feature"], function (a, b, c, d, e, f, g) {
            b.__markCompiled && b.__markCompiled();
            var h = {messengerpreconfirmation: {mobile_fullsize: true}, messengeraccountconfirmation: {mobile_fullsize: true}, messengertoggle: {mobile_fullsize: true}, post: {fluid: g('fluid_embed', false), mobile_fullsize: true}, video: {fluid: true, full_width: true}};
            e.exports = h;
        }, null);
        ...
        __d("sdk.XFBML.IframeWidget", ["sdk.Arbiter", "sdk.Auth", "sdk.Content", "sdk.DOM", "sdk.Event", "sdk.XFBML.Element", "guid", "insertIframe", "QueryString", "sdk.Runtime", "sdk.ui", "UrlMap", "sdk.XD"], function (a, b, c, d, e, f, g, h, i, j, k, l, m, n, o, p, q, r, s) {
            ...
            var t = l.extend({_iframeName: null, _showLoader: true, _refreshOnAuthChange: false, _allowReProcess: false, _fetchPreCachedLoader: false, _visibleAfter: 'load', _widgetPipeEnabled: false, _borderReset: false, _repositioned: false, getUrlBits: function () {
                    ...
                    return true;
                }, oneTimeSetup: function () {}, getSize: function () {}, getIframeName: function () {
        ...
        __d("sdk.XFBML.Comments", ["sdk.Event", "sdk.XFBML.IframeWidget", "QueryString", "sdk.Runtime", "JSSDKConfig", "sdk.UA", "UrlMap", "sdk.feature"], function (a, b, c, d, e, f, g, h, i, j, k, l, m, n) {
            b.__markCompiled && b.__markCompiled();
            var o = h.extend({_visibleAfter: 'immediate', _refreshOnAuthChange: true, setupAndValidate: function () {
                    ...
                    if (!p.href) {
                        ...
                        if (!p.xid) {
                            ...
                            if (q > 0) {
                                ...
                                p.xid = encodeURIComponent(document.URL);
                        }
                        if (p.migrated)
                            p.href = m.resolve('www') + '/plugins/comments_v1.php?' + 'app_id=' + j.getClientID() + '&xid=' + encodeURIComponent(p.xid) + '&url=' + encodeURIComponent(p.url);
                    } else {
                        var r = this.getAttribute('fb_comment_id');
                        if (!r) {
                            r = i.decode(document.URL.substring(ES(document.URL, 'indexOf', true, '?') + 1)).fb_comment_id;
                            if (r && ES(r, 'indexOf', true, '#') > 0)
                                r = r.substring(0, ES(r, 'indexOf', true, '#'));
                        }
                        if (r) {
                            p.fb_comment_id = r;
                            this.subscribe('render', ES(function () {
                    ...
                    if (this._attr.mobile && !n('one_comment_controller', false) && this._attr.version !== 'v2.3')
                        return m.resolve('m', true);
                    return m.resolve('www', true);
                }, _handleCommentCreatedMsg: function (p) {
                    if (!this.isValid())
                        return;
                    var q = {href: p.href, commentID: p.commentID, parentCommentID: p.parentCommentID, message: p.message};
                    g.fire('comment.create', q);
                }, _handleCommentRemovedMsg: function (p) {
                    if (!this.isValid())
                        return;
                    var q = {href: p.href, commentID: p.commentID};
        ...
        __d("legacy:fb.xfbml", ["Assert", "sdk.Event", "FB", "IframePlugin", "PluginConfig", "PluginTags", "XFBML", "sdk.domReady", "sdk.feature", "wrapFunction", "sdk.XFBML.Comments", "sdk.XFBML.CommentsCount", "sdk.XFBML.LoginButton", "sdk.XFBML.Name", "sdk.XFBML.Registration"], function (a, b, c, d, e, f, g, h, i, j, k, l, m, n, o, p) {
            ...
            i.provide('XFBML', {parse: function (t) {
    ...
    new Image().src = "https:\/\/www.facebook.com\/" + 'common/scribe_endpoint.php?c=jssdk_error&m=' + encodeURIComponent('{"error":"LOAD", "extra": {"name":"' + e.name + '","line":"' + (e.lineNumber || e.line) + '","script":"' + (e.fileName || e.sourceURL || e.script) + '","stack":"' + (e.stackTrace || e.stack) + '","revision":"1799518","message":"' + e.message + '"}}');
}