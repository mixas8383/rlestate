var qq = function(a){return{hide:function(){a.style.display = "none"; return this}, attach:function(b, c){a.addEventListener?a.addEventListener(b, c, !1):a.attachEvent && a.attachEvent("on" + b, c); return function(){qq(a).detach(b, c)}}, detach:function(b, c){a.removeEventListener?a.removeEventListener(b, c, !1):a.attachEvent && a.detachEvent("on" + b, c); return this}, contains:function(b){return a === b?!0:a.contains?a.contains(b):!!(b.compareDocumentPosition(a) & 8)}, insertBefore:function(b){b.parentNode.insertBefore(a, b);
        ...
        {}}}}};
        qq.DragAndDrop = function(a){function b(){k === p && !i && (g.callbacks.log("Grabbed " + l.length + " files after tree traversal."), m.dropDisabled(!1), g.callbacks.dropProcessing(!1, l))}function c(a){var d; k += 1; a.isFile?a.file(function(a){l.push(a); p += 1; b()}):a.isDirectory && (i = !0, a = a.createReader(), a.readEntries(function(a){p += 1; for (d = 0; d < a.length; d += 1)c(a[d]); i = !1; a.length || b()}))}function d(a){m = new qq.UploadDropZone({element:a, onEnter:function(b){qq(a).addClass(g.classes.dropActive); b.stopPropagation()}, onLeaveNotDescendants:function(){qq(a).removeClass(g.classes.dropActive)},
                onDrop:function(d){g.hideDropzones && qq(a).hide(); qq(a).removeClass(g.classes.dropActive); var d = d.dataTransfer, e, f; g.callbacks.dropProcessing(!0); m.dropDisabled(!0); if (1 < d.files.length && !g.multiple)g.callbacks.dropProcessing(!1), g.callbacks.error("tooManyFilesError", ""), m.dropDisabled(!1); else if (l = [], p = k = 0, qq.isFolderDropSupported(d)){e = d.items; for (d = 0; d < e.length; d += 1)if (f = e[d].webkitGetAsEntry())f.isFile?(l.push(e[d].getAsFile()), d === e.length - 1 && b()):c(f)} else g.callbacks.dropProcessing(!1, d.files),
                        m.dropDisabled(!1)}}); s.addDisposer(function(){m.dispose()}); g.hideDropzones && qq(a).hide()}function e(a){var b; qq.each(a.dataTransfer.types, function(a, c){if ("Files" === c)return b = !0, !1}); return b}function f(){g.dropArea && g.extraDropzones.push(g.dropArea); var a, b = g.extraDropzones; for (a = 0; a < b.length; a += 1)d(b[a]); g.dropArea && (!qq.ie() || qq.ie10()) && s.attach(document, "dragenter", function(c){if (!m.dropDisabled() && e(c) && !qq(g.dropArea).hasClass(g.classes.dropDisabled)){g.dropArea.style.display = "block"; for (a =
                0; a < b.length; a += 1)b[a].style.display = "block"}}); s.attach(document, "dragleave", function(c){if (g.hideDropzones && qq.FineUploader.prototype._leaving_document_out(c))for (a = 0; a < b.length; a += 1)qq(b[a]).hide()}); s.attach(document, "drop", function(c){if (g.hideDropzones)for (a = 0; a < b.length; a += 1)qq(b[a]).hide(); c.preventDefault()})}var g, m, i, l = [], k = 0, p = 0, s = new qq.DisposeSupport; g = {dropArea:null, extraDropzones:[], hideDropzones:!0, multiple:!0, classes:{dropActive:null}, callbacks:{dropProcessing:function(){}, error:function(){},
                log:function(){}}}; qq.extend(g, a); return{setup:function(){f()}, setupExtraDropzone:function(a){g.extraDropzones.push(a); d(a)}, removeExtraDropzone:function(a){var b, c = g.extraDropzones; for (b in c)if (c[b] === a)return c.splice(b, 1)}, dispose:function(){s.dispose(); m.dispose()}}};
        qq.UploadDropZone = function(a){function b(){return qq.safari() || qq.firefox() && qq.windows()}function c(a){if (qq.ie() && !qq.ie10())return!1; var b = a.dataTransfer, c = qq.safari(), a = qq.ie10()?!0:"none" !== b.effectAllowed; return b && a && (b.files || !c && b.types.contains && b.types.contains("Files"))}function d(a){void 0 !== a && (g = a); return g}var e, f, g, m, i = new qq.DisposeSupport; e = {element:null, onEnter:function(){}, onLeave:function(){}, onLeaveNotDescendants:function(){}, onDrop:function(){}}; qq.extend(e, a); f = e.element;
                (function(){m || (b?i.attach(document, "dragover", function(a){a.preventDefault()}):i.attach(document, "dragover", function(a){a.dataTransfer && (a.dataTransfer.dropEffect = "none", a.preventDefault())}), m = !0)})(); (function(){i.attach(f, "dragover", function(a){if (c(a)){var b = qq.ie()?null:a.dataTransfer.effectAllowed; a.dataTransfer.dropEffect = "move" === b || "linkMove" === b?"move":"copy"; a.stopPropagation(); a.preventDefault()}}); i.attach(f, "dragenter", function(a){if (!d() && c(a))e.onEnter(a)}); i.attach(f, "dragleave",
        ...
        qq.AjaxRequestor = function(a){function b(a){var b = qq.indexOf(i, a), d = k.maxConnections; delete l[a]; i.splice(b, 1); i.length >= d && b < d && (a = i[d - 1], c(a))}function c(a){var b = new XMLHttpRequest, c = f(), i = {}, r; k.onSend(a); k.paramsStore.getParams && (i = k.paramsStore.getParams(a)); r = i; var t = k.endpointStore.getEndpoint(a), z = l[a].addToPath; void 0 !== z && (t += "/" + z); r = m && r?qq.obj2url(r, t):t; l[a].xhr = b; b.onreadystatechange = d(a); b.open(c, r, !0); k.cors.expected && k.cors.sendCredentials && (b.withCredentials = !0); e(a); g("Sending " +
                c + " request for " + a); !m && i?b.send(qq.obj2url(i, "")):b.send()}function d(a){var c = l[a].xhr; return function(){if (4 === c.readyState){var d = l[a].xhr, e = f(), i = !1; b(a); 0 <= qq.indexOf(k.successfulResponseCodes, d.status) || (i = !0, g(e + " request for " + a + " has failed - response code " + d.status, "error")); k.onComplete(a, d, i)}}}function e(a){var b = l[a].xhr, a = k.customHeaders; b.setRequestHeader("X-Requested-With", "XMLHttpRequest"); b.setRequestHeader("Cache-Control", "no-cache"); qq.each(a, function(a, c){b.setRequestHeader(a,
                c)})}function f(){return k.demoMode?"GET":k.method}var g, m, i = [], l = [], k = {method:"POST", maxConnections:3, customHeaders:{}, endpointStore:{}, paramsStore:{}, successfulResponseCodes:[200], demoMode:!1, cors:{expected:!1, sendCredentials:!1}, log:function(){}, onSend:function(){}, onComplete:function(){}, onCancel:function(){}}; qq.extend(k, a); g = k.log; m = "GET" === f() || "DELETE" === f(); return{send:function(a, b){l[a] = {addToPath:b}; i.push(a) <= k.maxConnections && c(a)}, cancel:function(a){var c = l[a].xhr, d = f(); c?(c.onreadystatechange =
        ...
        qq.UploadHandlerForm = function(a, b, c){function d(a){void 0 !== p[a] && (p[a](), delete p[a])}function e(a, b){var c = a.id; r[k[c]] = b; p[c] = qq(a).attach("load", function(){l[c] && (q("Received iframe load event for CORS upload request (file id " + c + ")"), s[c] = setTimeout(function(){var a = "No valid message received from loaded iframe for file id " + c; q(a, "error"); b({error:a})}, 1E3))}); x.receiveMessage(c, function(a){q("Received the following window message: '" + a + "'"); var b = qq.parseJson(a), e = b.uuid; e && r[e]?(clearTimeout(s[c]),
                delete s[c], d(c), a = r[e], delete r[e], x.stopReceivingMessages(c), a(b)):e || q("'" + a + "' does not contain a UUID - ignoring.")})}function f(a, b){i.cors.expected?e(a, b):p[a.id] = qq(a).attach("load", function(){q("Received response for " + a.id); if (a.parentNode){try{if (a.contentDocument && a.contentDocument.body && "false" == a.contentDocument.body.innerHTML)return} catch (c){q("Error when attempting to access iframe during handling of upload response (" + c + ")", "error")}b()}})}function g(a){var b = qq.toElement('<iframe src="javascript:false;" name="' +
                a + '" />'); b.setAttribute("id", a); b.style.display = "none"; document.body.appendChild(b); return b}function m(a, b){var c = i.paramsStore.getParams(a), d = qq.toElement('<form method="' + (i.demoMode?"GET":"POST") + '" enctype="multipart/form-data"></form>'), e = i.endpointStore.getEndpoint(a), f = e; c[i.uuidParamName] = k[a]; i.paramsInBody?qq.obj2Inputs(c, d):f = qq.obj2url(c, e); d.setAttribute("action", f); d.setAttribute("target", b.name); d.style.display = "none"; document.body.appendChild(d); return d}var i = a, l = [], k = [], p = {}, s =
        {}, q = c, x = new qq.WindowReceiveMessage({log:q}), r = {}, t; return t = {add:function(a){a.setAttribute("name", i.inputName); var b = l.push(a) - 1; k[b] = qq.getUniqueId(); a.parentNode && qq(a).remove(); return b}, getName:function(a){if (t.isValid(a))return l[a].value.replace(/.*(\/|\\)/, ""); q(a + " is not a valid item ID.", "error")}, isValid:function(a){return void 0 !== l[a]}, reset:function(){l = []; k = []; p = {}}, getUuid:function(a){return k[a]}, cancel:function(a){i.onCancel(a, this.getName(a)); delete l[a]; delete k[a]; delete p[a];
                i.cors.expected && (clearTimeout(s[a]), delete s[a], x.stopReceivingMessages(a)); if (a = document.getElementById(a))a.setAttribute("src", "java" + String.fromCharCode(115) + "cript:false;"), qq(a).remove()}, upload:function(a){var c = l[a], e = t.getName(a), k = g(a), h; if (!c)throw Error("file with passed id was not added, or already uploaded or cancelled"); i.onUpload(a, this.getName(a)); h = m(a, k); h.appendChild(c); f(k, function(c){q("iframe loaded"); if (!c){var f; try{var h = k.contentDocument || k.contentWindow.document, g = h.body.innerHTML;
                q("converting iframe's innerHTML to JSON"); q("innerHTML = " + g); g && g.match(/^<pre/i) && (g = h.body.firstChild.firstChild.nodeValue); f = qq.parseJson(g)} catch (j){q("Error when attempting to parse form upload response (" + j + ")", "error"), f = {success:!1}}c = f}d(a); i.cors.expected || qq(k).remove(); if (c.success || !i.onAutoRetry(a, e, c))i.onComplete(a, e, c), b(a)}); q("Sending upload request for " + a); h.submit(); qq(h).remove(); return a}}};
        qq.UploadHandlerXhr = function(a, b, c){function d(a, b, c){var d = o.getSize(a), a = o.getName(a); b[j.chunking.paramNames.partIndex] = c.part; b[j.chunking.paramNames.partByteOffset] = c.start; b[j.chunking.paramNames.chunkSize] = c.size; b[j.chunking.paramNames.totalParts] = c.count; b[j.totalFileSizeParamName] = d; w && (b[j.chunking.paramNames.filename] = a)}function e(a, b){var c = j.chunking.partSize, d = o.getSize(a), e = h[a].file || h[a].blobData.blob, g = c * b, c = g + c >= d?d:g + c, d = f(a), i; e.slice?i = e.slice(g, c):e.mozSlice?i = e.mozSlice(g,
                c):e.webkitSlice && (i = e.webkitSlice(g, c)); return{part:b, start:g, end:c, count:d, blob:i, size:c - g}}function f(a){a = o.getSize(a); return Math.ceil(a / j.chunking.partSize)}function g(a){var b = new XMLHttpRequest; return h[a].xhr = b}function m(a, b, c, d){var e = new FormData, f = j.demoMode?"GET":"POST", g = j.endpointStore.getEndpoint(d), i = g, k = o.getName(d), l = o.getSize(d), m = h[d].blobData; a[j.uuidParamName] = h[d].uuid; w && (a[j.totalFileSizeParamName] = l, m && (a[j.blobs.paramNames.name] = m.name)); j.paramsInBody || (w || (a[j.inputName] =
                k), i = qq.obj2url(a, g)); b.open(f, i, !0); j.cors.expected && j.cors.sendCredentials && (b.withCredentials = !0); return w?(j.paramsInBody && qq.obj2FormData(a, e), e.append(j.inputName, c), e):c}function i(a, b){var c = j.customHeaders, d = h[a].file || h[a].blobData.blob; b.setRequestHeader("X-Requested-With", "XMLHttpRequest"); b.setRequestHeader("Cache-Control", "no-cache"); w || (b.setRequestHeader("Content-Type", "application/octet-stream"), b.setRequestHeader("X-Mime-Type", d.type)); qq.each(c, function(a, c){b.setRequestHeader(a,
                c)})}function l(a, b, c){var d = o.getName(a), e = o.getSize(a); h[a].attemptingResume = !1; j.onProgress(a, d, e, e); j.onComplete(a, d, b, c); delete h[a].xhr; B(a)}function k(a){var b = h[a].remainingChunkIdxs[0], c = e(a, b), f = g(a), k = o.getSize(a), l = o.getName(a), n; void 0 === h[a].loaded && (h[a].loaded = 0); v && h[a].file && x(a, c); f.onreadystatechange = q(a, f); f.upload.onprogress = function(c){if (c.lengthComputable){var d = c.loaded + h[a].loaded, c = c.total, f = e(a, b), c = c - f.size, g = o.getSize(a), f = f.count, i = c - h[a].initialRequestOverhead; h[a].lastRequestOverhead =
                c; if (b === 0){h[a].lastChunkIdxProgress = 0; h[a].initialRequestOverhead = c; h[a].estTotalRequestsSize = g + f * c} else if (h[a].lastChunkIdxProgress !== b){h[a].lastChunkIdxProgress = b; h[a].estTotalRequestsSize = h[a].estTotalRequestsSize + i}j.onProgress(a, l, d, h[a].estTotalRequestsSize)}}; j.onUploadChunk(a, l, s(c)); n = j.paramsStore.getParams(a); d(a, n, c); h[a].attemptingResume && (n[j.resume.paramNames.resuming] = !0); n = m(n, f, c.blob, a); i(a, f); u("Sending chunked upload request for item " + a + ": bytes " + (c.start + 1) + "-" + c.end + " of " +
                k); f.send(n)}function p(a){u("Server has ordered chunking effort to be restarted on next attempt for item ID " + a, "error"); v && (r(a), h[a].attemptingResume = !1); h[a].remainingChunkIdxs = []; delete h[a].loaded; delete h[a].estTotalRequestsSize; delete h[a].initialRequestOverhead}function s(a){return{partIndex:a.part, startByte:a.start + 1, endByte:a.end, totalParts:a.count}}function q(a, b){return function(){if (4 === b.readyState){var c; if (h[a]){u("xhr - server response received for " + a); u("responseText = " + b.responseText);
                try{c = qq.parseJson(b.responseText)} catch (d){u("Error when attempting to parse xhr response text (" + d + ")", "error"), c = {}}if (200 !== b.status || !c.success || c.reset)if (c.reset && p(a), h[a].attemptingResume && c.reset)h[a].attemptingResume = !1, u("Server has declared that it cannot handle resume for item ID " + a + " - starting from the first chunk", "error"), p(a), o.upload(a, !0); else{var f = o.getName(a); j.onAutoRetry(a, f, c, b) || l(a, c, b)} else if (A){var f = h[a].remainingChunkIdxs.shift(), g = e(a, f); h[a].attemptingResume = !1;
                var f = h[a], i = f.loaded, g = g.size, m; m = w?h[a].lastRequestOverhead:0; f.loaded = i + (g + m); 0 < h[a].remainingChunkIdxs.length?k(a):(v && r(a), l(a, c, b))} else l(a, c, b)}}}}function x(a, b){var c = o.getUuid(a), d = h[a].loaded, e = h[a].initialRequestOverhead, f = h[a].estTotalRequestsSize, g = t(a); qq.setCookie(g, c + n + b.part + n + d + n + e + n + f, j.resume.cookiesExpireIn)}function r(a){h[a].file && (a = t(a), qq.deleteCookie(a))}function t(a){var b = o.getName(a), a = o.getSize(a), c = j.chunking.partSize, b = "qqfilechunk" + n + encodeURIComponent(b) + n + a + n +
                c; void 0 !== y && (b += n + y); return b}function z(a){var b = h[a].file || h[a].blobData.blob, c = o.getName(a), d, e; h[a].loaded = 0; d = g(a); d.upload.onprogress = function(b){b.lengthComputable && (h[a].loaded = b.loaded, j.onProgress(a, c, b.loaded, b.total))}; d.onreadystatechange = q(a, d); e = j.paramsStore.getParams(a); b = m(e, d, b, a); i(a, d); u("Sending upload request for " + a); d.send(b)}var j = a, B = b, u = c, h = [], n = "|", A = j.chunking.enabled && qq.isFileChunkingSupported(), v = j.resume.enabled && A && qq.areCookiesEnabled(), y; y = null !== j.resume.id &&
                void 0 !== j.resume.id && !qq.isFunction(j.resume.id) && !qq.isObject(j.resume.id)?j.resume.id:void 0; var w = j.forceMultipart || j.paramsInBody, o; return o = {add:function(a){if (a instanceof File)a = h.push({file:a}) - 1; else if (a.blob instanceof Blob)a = h.push({blobData:a}) - 1; else throw Error("Passed obj in not a File or BlobData (in qq.UploadHandlerXhr)"); h[a].uuid = qq.getUniqueId(); return a}, getName:function(a){if (o.isValid(a)){var b = h[a].file, a = h[a].blobData; return b?null !== b.fileName && void 0 !== b.fileName?b.fileName:
                b.name:a.name}u(a + " is not a valid item ID.", "error")}, getSize:function(a){a = h[a].file || h[a].blobData.blob; return qq.isFileOrInput(a)?null != a.fileSize?a.fileSize:a.size:a.size}, getFile:function(a){if (h[a])return h[a].file || h[a].blobData.blob}, getLoaded:function(a){return h[a].loaded || 0}, isValid:function(a){return void 0 !== h[a]}, reset:function(){h = []}, getUuid:function(a){return h[a].uuid}, upload:function(a, b){var c = this.getName(a); j.onUpload(a, c); if (A){var d = o.getName(a), c = 0, g, i; if (!h[a].remainingChunkIdxs ||
                0 === h[a].remainingChunkIdxs.length){h[a].remainingChunkIdxs = []; if (v && !b && h[a].file){a:{g = qq.getCookie(t(a)); i = o.getName(a); var l, m, p; if (g){g = g.split(n); if (5 === g.length){i = g[0]; l = parseInt(g[1], 10); m = parseInt(g[2], 10); p = parseInt(g[3], 10); g = parseInt(g[4], 10); g = {uuid:i, part:l, lastByteSent:m, initialRequestOverhead:p, estTotalRequestsSize:g}; break a}u("Ignoring previously stored resume/chunk cookie for " + i + " - old cookie format", "warn")}g = void 0}g && (i = e(a, g.part), !1 !== j.onResume(a, d, s(i)) && (c = g.part, h[a].uuid =
                ...
                n + ".+\\" + n + "\\d+\\" + n + j.chunking.partSize + "=")):qq.getCookieNames(RegExp("^qqfilechunk\\" + n + ".+\\" + n + "\\d+\\" + n + j.chunking.partSize + "\\" + n + y + "=")), qq.each(a, function(a, c){var d = c.split(n), e = qq.getCookie(c).split(n); b.push({name:decodeURIComponent(d[1]), size:d[2], uuid:e[0], partIdx:e[1]})}), b):[]}}};