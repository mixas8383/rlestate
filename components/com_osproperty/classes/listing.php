...
class OspropertyListing
{
    ...
    static function details($option)
    {
        ...
        if ($configClass['relate_properties'] == 1)
        {
            ...
            $select = sprintf(", ( %s * acos( cos( radians('%s') ) * 
								...
								AS distance", $multiFactor, doubleval($property->lat_add), doubleval($property->long_add), doubleval($property->lat_add)
            );
    ...
    static function edit($option, $id, $type = 0)
    {
        ...
        { //allow to integrate with membership
            if (intval($id) == 0)
            {
                //is New
    ...
    static function save($option, $save)
    {
        ...
        } else
        {
            ...
            } elseif (intval($configClass['integrate_membership']) == 1)
            {//integrate with Membership component
