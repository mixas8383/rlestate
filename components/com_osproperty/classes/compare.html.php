				...
				for($i=0;$i<count($comparisionArr);$i++){
					...
					if($photo->image != ""){
						if(file_exists(JPATH_ROOT.DS."images/osproperty/properties/".$property->id."/".$photo->image)){
							...
							$comparisionArr[$i]->property->photo = JUri::root()."components/com_osproperty/images/assets/nopropertyphoto.png";
						}
					}else{
						$comparisionArr[$i]->property->photo = JUri::root()."components/com_osproperty/images/assets/nopropertyphoto.png";
					}
						...
						<table  width="100%" class="table table-striped" id="compare_table">
							<tr class="row0">
								...
								for($i=0;$i<count($comparisionArr);$i++){
									...
									?>
									<td width="<?php echo $per_column?>%" style="text-align:left;padding-left:5px;background-color:#efefef;font-weight:bold;" data-label="<?php echo JText::_("Ref #"); ?>&nbsp;">
							...
							<tr class="row1">
								...
								for($i=0;$i<count($comparisionArr);$i++){
									...
									?>
									<td width="<?php echo $per_column?>%" style="text-align:left;padding-left:5px;background-color:#efefef;font-weight:bold;" data-label="<?php echo JText::_("OS_PROPERTY_NAME"); ?>&nbsp;">
							...
							<tr class="row0">
								...
								for($i=0;$i<count($comparisionArr);$i++){
									...
									$property = $p->property;
									?>
									<td width="<?php echo $per_column?>%" style="text-align:center;" data-label="<?php echo OSPHelper::getLanguageFieldValue($property,'pro_name'); ?>">
										<?php
										if($photo->image != ""){
										?>
											<?php
							...
							<tr class="row1">
								...
								for($i=0;$i<count($comparisionArr);$i++){
									...
									$property = $p->property;
									?>
									<td width="<?php echo $per_column?>%" style="text-align:left;padding-left:5px;background-color:#efefef;" data-label="<?php echo OSPHelper::getLanguageFieldValue($property,'pro_name'); ?>">
										<?php
										if($p->show_address == 1){
							...
							<tr class="row0">
								...
								for($i=0;$i<count($comparisionArr);$i++){
									...
									?>
									<td width="<?php echo $per_column?>%" style="text-align:left;padding-left:5px;background-color:#FFF;" data-label="<?php echo OSPHelper::getLanguageFieldValue($property,'pro_name'); ?>">
										<?php
							...
							<tr class="row1">
								...
								for($i=0;$i<count($comparisionArr);$i++){
									...
									$property = $p->property;
									?>
									<td width="<?php echo $per_column?>%" style="text-align:left;padding-left:5px;background-color:#efefef;" valign="top" data-label="<?php echo OSPHelper::getLanguageFieldValue($property,'pro_name'); ?>">
										<?php
								...
								for($f=0;$f<count($fields);$f++){
									...
									<tr class="row<?php echo $k?>">
										...
										for($i=0;$i<count($comparisionArr);$i++){
											...
											$property = $p->fieldarr;
											?>
											<td width="<?php echo $per_column?>%" style="text-align:left;padding-left:5px;" valign="top" data-label="<?php echo OSPHelper::getLanguageFieldValue($property,'pro_name'); ?>">
												<?php
