	...
	static function getDirectionForm($option,$property,$lists,$address,$pro_address){
		...
		<div class="row-fluid">
			<div class="span12" style="margin-left:0px;">
					...
					?>
					<a href="<?php echo JRoute::_('index.php?option=com_osproperty&task=property_details&id='.$property->id.'&Itemid='.$itemid);?>" class="btn"><?php echo JText::_('OS_BACK_TO_PROPERTY');?></a>
			</div>
		</div>
		<div class="row-fluid">
			<div class="span12">
