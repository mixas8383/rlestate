                                        ...
                                        <div class="row-fluid ospitem-toppad">
                                            <div class="span12">
                                                <span class="ospitem-propertyprice title-blue">
                                                    ...
                                                    {
                                                        ?>
                                                        <a href="#map_canvas" onclick="javascript:openMarker(<?php echo $row->mapid; ?>);"><img src="<?php echo JURI::root() ?>components/com_osproperty/images/assets/map_magnify.png" border="0" title="<?php echo JText::_('OS_CHECK_ON_THE_MAP') ?>"></a>
                                                        <?php
                                                    }
