                    ...
                    <div class="row-fluid os_item">
                        <div class="os_property-title row-fluid">
                            <div class="span9">
                                ...
                                {
                                    ?>
                                    <a href="#map_canvas" onclick="javascript:openMarker(<?php echo $row->mapid; ?>);return false;"><img src="<?php echo JURI::root() ?>components/com_osproperty/images/assets/map_magnify.png" border="0" title="<?php echo JText::_('OS_CHECK_ON_THE_MAP') ?>"></a>
                                    <?php
                                }
