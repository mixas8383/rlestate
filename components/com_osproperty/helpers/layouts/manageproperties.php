...
<?php echo $lists['category']; ?>
        ...
        <div class="btn-toolbar hidden-phone">
            <div class="btn-group">
                <?php
                if (($configClass['integrate_membership'] == 0) and ( $supervisor == 0))
                {
                    ?>
...
<?php echo JText::_('OS_PRINT') ?>
            ...
            if (count($rows) > 0)
            {
                ...
                for ($i = 0; $i < count($rows); $i++)
                {
                    ...
                    $extend_link = JRoute::_("index.php?option=com_osproperty&task=property_edit&id=" . $row->id . "&extend=1");
                    ?>
                                ...
                                if ($row->isFeatured == 1)
                                {
                                    ...
                                    } else
                                    {
                                        ...
                                        if ($configClass['integrate_membership'] == 0)
                                        {
                                            ?>
                                            <BR>
                                            <a href="<?php echo JUri::root() ?>index.php?option=com_osproperty&task=property_upgrade&cid[]=<?php echo $row->id ?>&Itemid=<?php echo $jinput->getInt('Itemid', 0); ?>" style="font-size:11px;color:gray;"><?php echo Jtext::_('OS_UPGRADE_FEATURED'); ?></a>
                                            <?php
                                        }
                                    }
                                } else
